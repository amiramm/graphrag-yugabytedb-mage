...
Run both commands from the repository root. First, download a tarball that
matches your machine's architecture — pick `aarch64` for Apple Silicon or
`x86_64` for Intel and AMD. You can find every build on the
[YugabyteDB downloads page](https://download.yugabyte.com/):

```sh
curl -Lo db/yugabyte-2026.1.1.1-b2-el8-aarch64.tar.gz \
  https://software.yugabyte.com/releases/2026.1.1.1/yugabyte-2026.1.1.1-b2-el8-aarch64.tar.gz
```
...
docker build --platform linux/arm64 \
  -f db/Dockerfile \
  --build-arg YB_TARBALL=yugabyte-2026.1.1.1-b2-el8-aarch64.tar.gz \
